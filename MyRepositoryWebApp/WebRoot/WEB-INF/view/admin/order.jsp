					...
					<div class="">
						<div class="card text-center">
							<div class="card-header">
						  	...
						  	<div class="card-body">
						  		<form method="post" action="admin/OrderSearchServlet?action=getOrder" onsubmit="return checkSelectSubmit();"> 
					...
					<div class="">
						<div class="card text-center">
							...
							<table class="table table-bordered text-center">
								...
								<form method="post" action="admin/OrderSearchServlet?action=orderResolved">
